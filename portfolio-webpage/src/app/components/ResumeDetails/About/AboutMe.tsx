const AboutMe = () =>{return (
    <div className={`hover:bg-gray-300 rounded`}>
      ...
      <p>
        ...
        Currently studying software development at CodeSpace, with a passion for web development and creating user-friendly applications.
        Skilled in using Figma and Notion for project planning and design.
      </p>
    </div>
  )};
